package com.shahaenterprisefsm.features.logoutsync.presentation
...
import com.shahaenterprisefsm.app.AppDatabase
import com.shahaenterprisefsm.app.NetworkConstant
...
import com.shahaenterprisefsm.app.utils.AppUtils
import com.shahaenterprisefsm.app.utils.Toaster
import com.shahaenterprisefsm.base.BaseResponse
import com.shahaenterprisefsm.base.presentation.BaseActivity
import com.shahaenterprisefsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.shahaenterprisefsm.features.billing.api.AddBillingRepoProvider
import com.shahaenterprisefsm.features.billing.model.AddBillingInputParamsModel
...
import com.shahaenterprisefsm.features.dashboard.presentation.ReasonDialog
...
import com.shahaenterprisefsm.features.document.model.AddEditDocumentInputParams
import com.shahaenterprisefsm.features.document.model.DocumentAttachmentModel
...
import com.shahaenterprisefsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.shahaenterprisefsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.shahaenterprisefsm.features.orderhistory.model.*
...
import com.shahaenterprisefsm.features.quotation.model.AddQuotInputModel
import com.shahaenterprisefsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.shahaenterprisefsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.shahaenterprisefsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.shahaenterprisefsm.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.shahaenterprisefsm.features.stockAddCurrentStock.ShopAddCurrentStockRequest
...
import com.shahaenterprisefsm.features.timesheet.model.AddTimeSheetInputModel
import com.shahaenterprisefsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.shahaenterprisefsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.shahaenterprisefsm.features.viewAllOrder.model.AddOrderInputProductList
import com.shahaenterprisefsm.mappackage.SendBrod
import com.shahaenterprisefsm.widgets.AppCustomTextView
import com.shahaenterprisefsm.MonitorService
import com.shahaenterprisefsm.MySingleton
import com.shahaenterprisefsm.features.addshop.model.*
import com.shahaenterprisefsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.shahaenterprisefsm.features.addshop.presentation.ShopExtraContactReq
import com.shahaenterprisefsm.features.addshop.presentation.multiContactRequestData
...
import com.shahaenterprisefsm.features.login.model.GetConcurrentUserResponse
import com.shahaenterprisefsm.features.login.model.WhatsappApiData
import com.shahaenterprisefsm.features.performance.model.Gps_status_list
import com.shahaenterprisefsm.features.performance.model.UpdateGpsInputListParamsModel
import com.shahaenterprisefsm.features.returnsOrder.ReturnProductList
import com.shahaenterprisefsm.features.returnsOrder.ReturnRequest
import com.shahaenterprisefsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xshahaenterprisefsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xshahaenterprisefsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xshahaenterprisefsmlogsample/log.zip").path);
